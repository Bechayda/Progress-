    ...
    : window(win), titleFont(titleFont), bodyFont(bodyFont), soundManager(soundManager)
{
    ...
    auto setupLabel = [&](sf::Text& text, const std::string& str, float x, float y) {
    ...
    playLabel.setFont(bodyFont);
    playLabel.setCharacterSize(20);
    playLabel.setString("Simula");
    playLabel.setFillColor(sf::Color::White);
    playLabel.setPosition(1220.f, 170.f); // Manually set

    // Buhayin ang Alaala label
    loadLabel.setFont(bodyFont);
    loadLabel.setCharacterSize(20);
    loadLabel.setString("Buhayin ang Alaala");
    loadLabel.setFillColor(sf::Color::White);
    loadLabel.setPosition(1260.f, 260.f);

    // Gabay label
    aboutLabel.setFont(bodyFont);
    aboutLabel.setCharacterSize(20);
    aboutLabel.setString("Gabay");
    aboutLabel.setFillColor(sf::Color::White);
    aboutLabel.setPosition(1212.f, 360.f);

    // Labasan label
    quitLabel.setFont(bodyFont);
    quitLabel.setCharacterSize(20);
    quitLabel.setString("Labasan");
    quitLabel.setFillColor(sf::Color::White);
    quitLabel.setPosition(1225.f, 450.f);
